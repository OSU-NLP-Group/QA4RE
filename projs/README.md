...
model=google/flan-t5-small
# remove --debug for entire run
python qa4re_hf_llm.py --mode $mode --dataset ${DATA} --type_constrained --run_setting zero_shot --prompt_config_name qa4re_prompt_config.yaml --model $model --use_t5 --debug
